@{
    ...
    PrivateData          = @{
        PSData = @{
            ...
            ReleaseNotes = 'Fix GitHub CLI authentication in the release workflow so tagged builds can publish assets and release notes without the third-party release action.'
        }
    }
}
